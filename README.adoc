...
| hideable | `boolean` | &#10004;&#65039; |  | Defines if the column is hideable.
| visible | `boolean` | &#10004;&#65039; |  | Defines if the column is visible. If used with hideable, the column will be in the column menu unchecked.
